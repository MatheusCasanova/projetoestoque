...
using EstoqueWeb.Infra.Data.Utils;
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Login(AccountLoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    //procurar o usuario no banco de dados atráves do email e senha
                    ...
                    if(usuario != null)
                    {
                        ...
                        //gravar os dados do usuario autenticado em sessão
        ...
        {
            //apagar os dados do usuario da sessão
